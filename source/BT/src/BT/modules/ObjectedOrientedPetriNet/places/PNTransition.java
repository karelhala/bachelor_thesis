...
public class PNTransition extends PNTransitionModel {
    ...
    /**
     * Draws transition on graphics. Helpfull when exporting, saving or just drawing.
     *
     * @param g
     */
    ...
    /**
     * Resize transition based on size of strings of guard and action. First resize width by stringwidth of action, then
