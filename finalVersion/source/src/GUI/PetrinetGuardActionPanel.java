...
/**
 * Class for holding guard and action text fields. These fields are disabled, if you wish to edit guard and action, go
 * to propriete class.
 *
 * @author Karel Hala
 */
public class PetrinetGuardActionPanel {
    ...
    /**
     * Initialize guard field and action field, insert them in content Pane. Make them disable.
     */
