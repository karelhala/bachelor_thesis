...
funkcí a vylep¹ení do tohoto nástroje. Nicménì jsou logicky vybrány a
z~pohledu momentálního stavu aplikace by znamenaly velmi mnoho. Do nástroje je 
...
jako napøíklad \emph{PNTalk} \footnote{Bli¾¹í informace o~tomto jazyku a
o~projektu PNTalk lze nalézt na stránkách: 
...
Tento nástroj má výhody oproti ostatním aplikacím pøevá¾nì díky jednoduchému a 
