...
ale ne naopak. \cite{Diagram_trid}

Dále jsou tyto hrany opatøeny násobností, neboli oznaèením kolik objektù je
pou¾ito kolika objekty.
...
objekt tøídy B nezaniká. Tomuto se øíká slabá agregace. \cite{Diagram_trid}
...
\begin{itemize}
  ...
  \item \(TI_N\) je \textbf{popis pøechodù}.
\end{itemize}
