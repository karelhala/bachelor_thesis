...
\(hlavního\) pøípadu u¾ití. \cite{Pripad_uziti}
...
skládají z metod, pøedpis pro práci s daty a relací mezi tøídami. \cite{Diagram_trid}
...
Omezení v názvosloví je èistì doporuèení a ne nutnost.\cite{Diagram_trid}
...
tøídách, které implementují takový interface. \cite{Diagram_trid}
...
\textbf{potomek}. \cite{Diagram_trid}

V UML je tato hrana popsána ¹ipkou ukonèenou bílím trojúhelníkem na konci,
je vedena smìrem od generické tøídy k více specifické. \cite{Diagram_trid}
